...
#top right
plot(my_epc$DateTime, my_epc$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
#bottom right
plot(my_epc$DateTime, my_epc$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
